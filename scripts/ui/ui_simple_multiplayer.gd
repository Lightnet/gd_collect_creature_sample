...
const DUMMY_PLAYER = preload("res://prefabs/dummy_player/network_player.tscn")

@onready var label_player_name: Label = $Label_PlayerName
@onready var label_network_type: Label = $Label_NetworkType
